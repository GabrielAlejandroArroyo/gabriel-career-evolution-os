...
import { logoImageClass, logoPlateClass, logoSrc } from "@/data/companies";
  ...
  return (
    <article className="rounded-xl border border-border bg-bg-inset px-5 py-5 md:px-6 md:py-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-6">
        <span
          className={`${logoPlateClass(company)} inline-flex h-14 w-40 shrink-0 items-center justify-center rounded-lg px-3 py-2`}
        >
          ...
          <img
            ...
            width={160}
            height={48}
            className={`${logoImageClass(company)} max-h-10 w-auto max-w-full object-contain`}
          />
        </span>
